...
public class SuccessClosingCardWindowController extends BSClientController {
    public static final String PATH_TO_FXML_FILE = "view/successClosingCardWindow.fxml";

    private static final Logger log = Logger
            .getLogger(SuccessClosingCardWindowController.class);
    ...
    @FXML
    private Label cardClosingDateLbl;
    @FXML
    ...
    public void loadDateAndStatusOfTransaction(final Date transactionDate,
        ...
        cardClosingDateLbl.setText(transactionDateAsString);
